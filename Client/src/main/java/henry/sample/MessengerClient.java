...
public class MessengerClient {
     ...
     */
    public MessengerClient(Channel channel) {
    ...
    public void greet(String name) {
        ...
        MessageRequest request = MessageRequest.newBuilder().setName(name).build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        ManagedChannel channel = ManagedChannelBuilder.forTarget(target)
                ...
                .build();
        try {
            MessengerClient client = new MessengerClient(channel);
            client.greet(user);
        } finally {
